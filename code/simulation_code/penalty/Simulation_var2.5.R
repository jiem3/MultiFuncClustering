...
cat("seed is ", SEED, "\n", sep="")
  ...
  mu1 <- c(c(14,14,rep(14,9),0), c(11,20,22,rep(23,5),seq(23,18,length.out=4)) ,rep(rep(0,12),16))   ## 2 informative sensor and 2 non-informative sensor, the mean is generated by 12 B-spline basis
 ...
 pgseq<-2.5
  ...
  write.csv(result_data, file = paste("result_MB_FDA_var2.5_para",SEED,".csv", sep = ""))
